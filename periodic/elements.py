...
def get(element):
    ...
    >>> magnesium = get(12) #'12','mg','Mg','magnesium','Magnesium', and 24.305 would have all worked just as well
    >>> magnesium
...
class element(object):
    ...
    * type
    ...
    >>> osmium=element('Os') #Here we create the element object. The input could have been any of the above types of input.
    >>> osmium.name
    'osmium'
    >>> osmium.symbol
    'Os'
